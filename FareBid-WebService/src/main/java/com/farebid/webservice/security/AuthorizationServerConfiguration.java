...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
  ...
  @Autowired
  private FareBidUserDetailsService userService;

  @Autowired
  FareBidClientDetailsService fareBidClientDetailsService;

  @Override
  public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
    clients.withClientDetails(fareBidClientDetailsService);
  }
  ...
  public JwtAccessTokenConverter accessTokenConverter() {
      ...
      converter.setSigningKey("FareBid-Key");
      return converter;
  }
}
